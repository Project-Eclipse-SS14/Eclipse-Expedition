...
ent-DieObjective = Умереть славной смертью.
    .desc = Умрите.
# HASH: bb5ca4e51530f36e5e804cf01a47ffb66176cd5e3032d2675b6faca6c0271557
ent-KillRandomPersonObjective = { "" }
    .desc = Сделайте это, как посчитаете нужным. Только убедитесь, что цель не покинет станцию.
# HASH: 3a9ab6a67416a501f9861c1dcbd36af2d232e40209003bfdda496053bac2ae65
ent-KillRandomHeadObjective = { "" }
    .desc = Нам нужно, чтобы этот глава исчез, и вы, вероятно, знаете почему. Убедитесь что цель не улетит на Центком. Удачи, агент.
