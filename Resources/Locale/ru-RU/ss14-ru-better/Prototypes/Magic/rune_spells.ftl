# HASH: 501330076c51af9be53c0673d111c02abfd0e7369131377cfad3ef2e970e561b
ent-ActionFlashRune = Руна вспышки
    .desc = Вызывает руну, которая ослепляет при использовании.
# HASH: 3679b40d818c889f3446d1beefe3b14c7260db59b5b169ac27e0fa173fecfb10
ent-ActionExplosionRune = Руна взрыва
    .desc = Вызывает руну, которая взрывается при использовании.
# HASH: fb06d71f7141ae06f0e2aaaf45e21e64d6438181c41c564db3f4991f140628aa
ent-ActionIgniteRune = Руна поджога
    .desc = Вызывает руну, которая поджигает при использовании.
# HASH: bf71c8ad3c5df7dc6f5067371f8d4ddaa33485395b0a84559a9bb67ea1471398
